...
const char* htmlCode = R"=====(
  ...
  startDruckSlider.setAttribute("step", "1");
  startDruckSlider.setAttribute("style", "width: 200px;");

  // Create div to contain start pressure slider
  var startDruckText = document.createTextNode("Start Pressure (bar): " + startDruckSlider.value);
  ...
  startDruckSlider.oninput = function () {
      startDruck = parseInt(startDruckSlider.value);
      drawZeiger(startDruck);
    startDruckText.nodeValue = "Start Pressure (bar): " + startDruckSlider.value;
  };
  ...
  druckAbfallSlider.setAttribute("min", "0.2");
  druckAbfallSlider.setAttribute("max", "15");
  druckAbfallSlider.setAttribute("value", "0.2");
  druckAbfallSlider.setAttribute("step", "0.2");
  ...
  druckAbfallSlider.oninput = function () {
    ...
    druckAbfallText.nodeValue= "Pressure Drop Rate (bar/s): "+ druckAbfallSlider.value;
  };
  ...
  // Function to draw the pointer on the gauge based on the current pressure<br>
...
// HTTP-Anfrage an den ESP8266 senden, um den Servo einzustellen
  ...
  function openSettingsPopup() {
    ...
    fetch("/getSSID")
        ...
        .then(currentSSID => {
            ...
            popupContainer.style.height = "auto"; // Adjusted to fit content dynamically

            // Creating the text field for entering SSID
            var textField = document.createElement("input");
            textField.setAttribute("type", "text");
            textField.setAttribute("id", "settingsTextField");
            textField.style.marginBottom = "10px";
            textField.value = currentSSID; // Set current SSID as default value
            ...
            // Hint for Wi-Fi connection note
  ...
  // Function to start the countdown timer<br>
